...
const Pools = ({megaLimitTime, megaPoolData}) => {
    return (
                    ...
                    <div className='col-lg-9' style={{ margin: 'auto' }}>
                        <div className='timer-box'>
                            <div className='content'>
                                ...
                                <h4 className='title'><img src="/logo.png" alt="" width={40} className='prize-currency' />{megaPoolData && new Intl.NumberFormat().format(Number(megaPoolData[6]) / 10 ** 18)}</h4>
                                <a href="/prize" className="link join-game">RIDE THE WAVE <i
                                    className="fas fa-arrow-right"></i></a>
                            </div>
                            <div className='timer-inner next-wave'>
                                <BigCountdown futureDate={Number(megaLimitTime)} />
                            </div>
                        </div>
                    </div>
                </div>
